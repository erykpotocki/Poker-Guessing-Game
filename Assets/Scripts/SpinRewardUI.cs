...
public sealed class SpinRewardUI : MonoBehaviour
{
    ...
    private void Build()
    {
        ...
        hint=Text(panel,"Darmowa próba co minutę",new Vector2(0,-370),new Vector2(720,50),26);
        hint.color=new Color(.7f,.77f,.72f);
        spin=Action(panel,"ODKRYJ NAGRODĘ",new Vector2(0,-485),new Vector2(520,100),Spin);
        spinCaption=spin.GetComponentInChildren<TMP_Text>();spinBackground=spin.GetComponent<Image>();
        timer=Text(panel,"",new Vector2(0,-580),new Vector2(720,54),26);
    ...
    private IEnumerator SpinWheel()
    {
        ...
        hint.text="Za chwilę poznasz swoją nagrodę";
        ...
        hint.text=avatar!=null?"Znajdziesz go w swoim profilu":"Nagroda jest już na Twoim koncie";
    ...
    private void Refresh()
    {
        ...
        spinCaption.text=spinning?"LOSUJEMY…":spin.interactable?"ODKRYJ NAGRODĘ":"WRÓĆ PO KOLEJNĄ NAGRODĘ";
